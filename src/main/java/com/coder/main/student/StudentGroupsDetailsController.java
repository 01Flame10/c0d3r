...
@Controller
@RequestMapping(value = "/studentGroupsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class StudentGroupsDetailsController {
