...
@Controller
@RequestMapping(value = "/studentAutotestResultsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class StudentAutotestResultsDetailsController {
