...
@Controller
@RequestMapping(value = "/studentTasksDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class StudentTasksDetailsController {
