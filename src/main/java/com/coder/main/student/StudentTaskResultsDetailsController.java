...
@Controller
@RequestMapping(value = "/studentTaskResultsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class StudentTaskResultsDetailsController {
