...
@Controller
@RequestMapping(value = "/studentClassesDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class StudentClassesDetailsController {
