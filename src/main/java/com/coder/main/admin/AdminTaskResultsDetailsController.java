...
@Controller
@RequestMapping(value = "/adminTaskResultsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class AdminTaskResultsDetailsController {
