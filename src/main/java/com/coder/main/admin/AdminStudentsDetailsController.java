...
@Controller
@RequestMapping(value = "/adminStudentsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class AdminStudentsDetailsController {
