...
@Controller
@RequestMapping(value = "/adminCourseSectionsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class AdminCourseSectionsDetailsController {
