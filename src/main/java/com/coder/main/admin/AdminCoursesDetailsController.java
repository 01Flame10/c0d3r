...
@Controller
@RequestMapping(value = "/adminCoursesDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class AdminCoursesDetailsController {
