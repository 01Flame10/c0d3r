...
@Controller
@RequestMapping("/adminAutotestPropertiesDelete")
public class AdminAutotestPropertiesDeleteController {
   ...
   public ModelAndView showPage(@RequestParam("id") String recordId, Model model) {
	  ...
	  ModelAndView mv = new ModelAndView("redirect:/adminAutotestProperties");
