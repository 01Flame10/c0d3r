...
@Controller
@RequestMapping(value = "/adminSourceCodesDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class AdminSourceCodesDetailsController {
