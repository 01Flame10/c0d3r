...
@Controller
@RequestMapping(value = "/adminTeachersDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class AdminTeachersDetailsController {
