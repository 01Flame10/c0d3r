...
@Controller
@RequestMapping("/adminAutotestResultsDelete")
public class AdminAutotestResultsDeleteController {
   ...
   public ModelAndView showPage(@RequestParam("id") String recordId, Model model) {
	  ...
	  ModelAndView mv = new ModelAndView("redirect:/adminAutotestResults");
