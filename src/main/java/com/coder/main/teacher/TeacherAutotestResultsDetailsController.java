...
@Controller
@RequestMapping(value = "/teacherAutotestResultsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class TeacherAutotestResultsDetailsController {
