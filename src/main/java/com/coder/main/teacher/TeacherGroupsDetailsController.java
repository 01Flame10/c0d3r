...
@Controller
@RequestMapping(value = "/teacherGroupsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class TeacherGroupsDetailsController {
