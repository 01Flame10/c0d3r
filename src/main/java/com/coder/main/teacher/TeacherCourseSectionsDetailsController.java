...
@Controller
@RequestMapping(value = "/teacherCourseSectionsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class TeacherCourseSectionsDetailsController {
