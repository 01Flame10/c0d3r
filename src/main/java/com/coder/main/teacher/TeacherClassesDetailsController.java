...
@Controller
@RequestMapping(value = "/teacherClassesDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class TeacherClassesDetailsController {
