...
@Controller
@RequestMapping(value = "/teacherTasksDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class TeacherTasksDetailsController {
