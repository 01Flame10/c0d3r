...
@Controller
@RequestMapping(value = "/teacherTeachersDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class TeacherTeachersDetailsController {
