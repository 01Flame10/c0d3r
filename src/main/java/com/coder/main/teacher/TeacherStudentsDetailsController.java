...
@Controller
@RequestMapping(value = "/teacherStudentsDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class TeacherStudentsDetailsController {
