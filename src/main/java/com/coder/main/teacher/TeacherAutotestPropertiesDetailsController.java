...
@Controller
@RequestMapping(value = "/teacherAutotestPropertiesDetails", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
public class TeacherAutotestPropertiesDetailsController {
